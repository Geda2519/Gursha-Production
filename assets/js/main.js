...
(function () {
  ...
  document.addEventListener('DOMContentLoaded', function () {
    ...
    document.querySelectorAll('.video-control').forEach(control => {
      const video = control.closest('.portfolio-entry').querySelector('.portfolio-video');
  ...
  /**
  * Init isotope layout and filters - MODIFIED VERSION
  */
document.querySelectorAll('.isotope-layout').forEach(function(isotopeItem) {
  ...
  imagesLoaded(isotopeItem.querySelector('.isotope-container'), function() {
    ...
    // Add initial active class to default filter
    const defaultFilter = isotopeItem.querySelector(`[data-filter="${filter}"]`);
    if (defaultFilter) {
  ...
  isotopeItem.querySelectorAll('.isotope-filters li').forEach(function(filterButton) {
    filterButton.addEventListener('click', function() {
      ...
      // Optional: Refresh AOS after layout changes
